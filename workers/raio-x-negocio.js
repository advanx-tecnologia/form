const SOURCE = 'https://raw.githubusercontent.com/advanx-tecnologia/form/main/raio-x-negocio/';
...
async function handle(request) {
  ...
  if (url.pathname === '/raio-x-negocio') {
    return Response.redirect(`${url.origin}/raio-x-negocio/`, 301);
  }

  const relativePath = url.pathname.replace(/^\/raio-x-negocio\//, '') || 'index.html';
